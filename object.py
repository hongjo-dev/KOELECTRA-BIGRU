...
# 로그 파일 생성
log_file = '/log/object_model_output_log.txt'
...
with torch.no_grad(), open(log_file, 'w', encoding='utf-8') as log:
    ...
    log.write(f"성능 평가 결과:\n{classification_report(grouped_true_labels, grouped_pred_labels, target_names=['Non-object', 'object'])}\n")
    log.write(f"object 클래스 F1 스코어: {Object_f1_score:.4f}\n")
